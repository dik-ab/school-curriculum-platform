...
| DMチャット | WebSocket、STOMPまたはシンプルWebSocket |
...
推奨リポジトリ名: `sns-spring-jpa-answer`

Spring版は、教材としては特に解答コードが重要です。設定ファイル、DI、例外ハンドリング、テストのつながりを本文だけで追うのは難しいため、章ごとに動くコミットを残します。
