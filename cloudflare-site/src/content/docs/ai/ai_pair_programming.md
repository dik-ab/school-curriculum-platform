---
title: AIペアプログラミング実践
description: 計画・実装・レビューのループでAIと開発を進める実践ワークフローと、学習効果を損なわないAIとの付き合い方を学ぶ
parent: AI開発入門
nav_order: 6
---
...
このセクションの仕上げとして、AIと一緒に開発を進める**実践的なワークフロー**を学びます。道具の使い方はすでに揃いました。[LLMの仕組み](/ai/what_is_llm/)を理解し、[Claude Codeを導入し](/ai/claude_code_setup/)、[CLAUDE.md](/ai/claude_md/)と[skills](/ai/skills_and_commands/)でプロジェクトに適応させ、[MCP](/ai/mcp/)で外部ツールにつなぎました。残る問いは「**で、実際の開発でどう使うのか？**」です。
